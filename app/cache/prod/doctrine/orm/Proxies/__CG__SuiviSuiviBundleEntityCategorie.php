 ...
 */
class Categorie extends \Suivi\SuiviBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'nom', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'description', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'dateCreation', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'offre');
        }
    ...
    public function addOffre(\Suivi\SuiviBundle\Entity\Offres $offre)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addOffre', array($offre));
    ...
    public function removeOffre(\Suivi\SuiviBundle\Entity\Offres $offre)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeOffre', array($offre));
