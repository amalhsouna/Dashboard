...
class Utilisateur extends \Utilisateur\UtilisateurBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'espace', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setEspace($espace)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEspace', array($espace));
    ...
    public function getEspace()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEspace', array());
