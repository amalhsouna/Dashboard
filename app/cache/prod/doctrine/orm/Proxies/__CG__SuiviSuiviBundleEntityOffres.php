...
class Offres extends \Suivi\SuiviBundle\Entity\Offres implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Offres' . "\0" . 'id', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Offres' . "\0" . 'nom', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Offres' . "\0" . 'description', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Offres' . "\0" . 'status', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Offres' . "\0" . 'prixunitaire', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Offres' . "\0" . 'categ', 'vent');
        }
