...
namespace Proxies\__CG__\Your\OwnCalendarBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Event extends \Your\OwnCalendarBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Your\\OwnCalendarBundle\\Entity\\Event' . "\0" . 'id', 'title', 'description', 'start', 'end', 'category');
        }
     ...
     * {@inheritDoc}
     */
    public function setCategory(\BladeTester\CalendarBundle\Model\EventCategoryInterface $category = NULL)
    {
