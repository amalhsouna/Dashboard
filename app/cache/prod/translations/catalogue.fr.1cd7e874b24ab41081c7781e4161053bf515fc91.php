...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'bladetester_calendar.validation.event_dates' => 'Un événement peut pas se terminer avant qu\'il ne commence.',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'bladetester_calendar.label.event.update' => 'Mettre à jour événement',
    ...
    'bladetester_calendar.label.configuration_parameters' => 'Les paramètres de configuration',
    ...
    'bladetester_calendar.title.category.add' => 'Ajouter nouvelle catégorie',
    'bladetester_calendar.label.category.edit' => 'Mettre à jour',
    'bladetester_calendar.title.category.edit' => 'Modifier une catégorie',
    ...
    'bladetester_calendar.flash.event_added' => 'Le nouvel événement "%title%" a été créée',
    'bladetester_calendar.flash.event_updated' => 'L\'événement "%title%" a été mis à jour',
    'bladetester_calendar.flash.event_deleted' => 'L\'événement "%title%" a été supprimée',
    'bladetester_calendar.flash.category_added' => 'Une nouvelle catégorie avec un nom %name% ont été ajoutées',
    'bladetester_calendar.flash.category_updated' => 'La catégorie %name% a été mis à jour',
    'bladetester_calendar.flash.category_deleted' => 'La catégorie %name% a été supprimée',
    'bladetester_calendar.flash.settings_updated' => 'Paramètres de l\'agenda ont été mis à jour',
    'bladetester_calendar.exception.event_not_found' => 'Événement avec id %id% pas trouvé',
    'bladetester_calendar.exception.category_not_found' => 'Catégorie avec id %id% pas trouvé',
