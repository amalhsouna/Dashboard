...
class Categorie extends \Suivi\SuiviBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'nom', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'description', '' . "\0" . 'Suivi\\SuiviBundle\\Entity\\Categorie' . "\0" . 'dateCreation', 'offre');
        }
