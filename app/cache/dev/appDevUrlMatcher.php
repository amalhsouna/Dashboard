...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/cont')) {
            ...
            if (0 === strpos($pathinfo, '/contrat/ajout-')) {
                // contrat_ajout
                if (0 === strpos($pathinfo, '/contrat/ajout-contrat') && preg_match('#^/contrat/ajout\\-contrat/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'contrat_ajout')), array (  '_controller' => 'Suivi\\SuiviBundle\\Controller\\ContratController::AjoutcontratAction',));
                }

                // facture_ajout
                if ($pathinfo === '/contrat/ajout-facture') {
                    return array (  '_controller' => 'Suivi\\SuiviBundle\\Controller\\ContratController::AjoutFactureAction',  '_route' => 'facture_ajout',);
                }
        ...
        if (0 === strpos($pathinfo, '/pdf-')) {
            ...
            // PDF_offre
            if ($pathinfo === '/pdf-offre') {
                return array (  '_controller' => 'Suivi\\SuiviBundle\\Controller\\PDFController::pdfoffAction',  '_route' => 'PDF_offre',);
            }

            // PDF_vente
            if ($pathinfo === '/pdf-vente') {
                return array (  '_controller' => 'Suivi\\SuiviBundle\\Controller\\PDFController::pdfventeAction',  '_route' => 'PDF_vente',);
            }
        ...
        // pie_chart
        if ($pathinfo === '/pie-chart') {
            return array (  '_controller' => 'Suivi\\SuiviBundle\\Controller\\ChartController::piechartAction',  '_route' => 'pie_chart',);
        }
