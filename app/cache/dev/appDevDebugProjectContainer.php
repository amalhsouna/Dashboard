...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'formation_user_registration.form.type' => 'getFormationUserRegistration_Form_TypeService',
    ...
    {
        return $this->services['blade_tester_calendar.calendar'] = new \BladeTester\CalendarBundle\Model\Calendar($this->get('doctrine.orm.default_entity_manager'), $this->get('debug.event_dispatcher'), 'Your\\OwnCalendarBundle\\Entity\\Event');
    }
    ...
    {
        return $this->services['blade_tester_calendar.forms.event'] = new \BladeTester\CalendarBundle\Form\Type\EventFormType('Your\\OwnCalendarBundle\\Entity\\Event');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gvente4', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Suivi\\SuiviBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Your\\OwnCalendarBundle\\Entity')));
        ...
        $d->addDriver($b, 'Suivi\\SuiviBundle\\Entity');
        $d->addDriver($b, 'Utilisateur\\UtilisateurBundle\\Entity');
        $d->addDriver($b, 'Your\\OwnCalendarBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('SuiviVenteBundle' => 'Suivi\\SuiviBundle\\Entity', 'UtilisateurBundle' => 'Utilisateur\\UtilisateurBundle\\Entity', 'BladeTesterCalendarBundle' => 'BladeTester\\CalendarBundle\\Entity', 'YourOwnCalendarBundle' => 'Your\\OwnCalendarBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f949b28a3457ca4001bdcbcbd578344dce056743872c33bde7f1afbe1cee1c2b');
    ...
    /**
     * Gets the 'formation_user_registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Utilisateur\UtilisateurBundle\Form\Type\RegistrationFormType A Utilisateur\UtilisateurBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getFormationUserRegistration_Form_TypeService()
    {
        return $this->services['formation_user_registration.form.type'] = new \Utilisateur\UtilisateurBundle\Form\Type\RegistrationFormType('Utilisateur\\UtilisateurBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'formation_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('haythembelkahla.26@gmail.com');
        $a->setPassword(22298622);
        $a->setAuthMode(NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Suivi\\SuiviBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.ar.yml'), 'ar', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.bg.yml'), 'bg', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.ca.yml'), 'ca', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.cs.yml'), 'cs', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.da.yml'), 'da', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.de.yml'), 'de', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.el.yml'), 'el', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.en.yml'), 'en', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.es.yml'), 'es', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.et.yml'), 'et', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.eu.yml'), 'eu', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.fa.yml'), 'fa', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.fi.yml'), 'fi', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.fr.yml'), 'fr', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.he.yml'), 'he', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.hr.yml'), 'hr', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.hu.yml'), 'hu', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.id.yml'), 'id', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.it.yml'), 'it', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.ja.yml'), 'ja', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.lb.yml'), 'lb', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.lt.yml'), 'lt', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.lv.yml'), 'lv', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.nb.yml'), 'nb', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.nl.yml'), 'nl', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.pl.yml'), 'pl', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.pt.yml'), 'pt', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.pt_BR.yml'), 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.ro.yml'), 'ro', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.ru.yml'), 'ru', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.sk.yml'), 'sk', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.sl.yml'), 'sl', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.sr_Latn.yml'), 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.sv.yml'), 'sv', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.th.yml'), 'th', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.tr.yml'), 'tr', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.uk.yml'), 'uk', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.vi.yml'), 'vi', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\FOSUserBundle.zh_CN.yml'), 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.ar.yml'), 'ar', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.bg.yml'), 'bg', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.ca.yml'), 'ca', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.cs.yml'), 'cs', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.da.yml'), 'da', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.de.yml'), 'de', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.el.yml'), 'el', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.en.yml'), 'en', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.es.yml'), 'es', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.eu.yml'), 'eu', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.fa.yml'), 'fa', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.fi.yml'), 'fi', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.fr.yml'), 'fr', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.he.yml'), 'he', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.hr.yml'), 'hr', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.hu.yml'), 'hu', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.id.yml'), 'id', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.it.yml'), 'it', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.ja.yml'), 'ja', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.lt.yml'), 'lt', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.lv.yml'), 'lv', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.nb.yml'), 'nb', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.nl.yml'), 'nl', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.pl.yml'), 'pl', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.pt.yml'), 'pt', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.pt_BR.yml'), 'pt_BR', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.ro.yml'), 'ro', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.ru.yml'), 'ru', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.sk.yml'), 'sk', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.sl.yml'), 'sl', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.sr_Latn.yml'), 'sr_Latn', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.sv.yml'), 'sv', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.th.yml'), 'th', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.tr.yml'), 'tr', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.uk.yml'), 'uk', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.vi.yml'), 'vi', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle/Resources/translations\\validators.zh_CN.yml'), 'zh_CN', 'validators');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\carlescliment\\calendar-bundle\\src\\BladeTester\\CalendarBundle/Resources/translations\\messages.eu.yml'), 'eu', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\carlescliment\\calendar-bundle\\src\\BladeTester\\CalendarBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\carlescliment\\calendar-bundle\\src\\BladeTester\\CalendarBundle/Resources/translations\\messages.pl.yml'), 'pl', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\carlescliment\\calendar-bundle\\src\\BladeTester\\CalendarBundle/Resources/translations\\validators.ca.yml'), 'ca', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\carlescliment\\calendar-bundle\\src\\BladeTester\\CalendarBundle/Resources/translations\\validators.en.yml'), 'en', 'validators');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\carlescliment\\calendar-bundle\\src\\BladeTester\\CalendarBundle/Resources/translations\\validators.pl.yml'), 'pl', 'validators');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Your\\OwnCalendarBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Suivi\\SuiviBundle/Resources/views'), 'SuiviVente');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Your\\OwnCalendarBundle/Resources/views'), 'YourOwnCalendar');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\Resources\\config\\validation.xml'), 2 => ($this->targetDirs[3].'\\src\\Utilisateur\\UtilisateurBundle\\Resources\\config\\validation.xml')));
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'\\src\\Suivi\\SuiviBundle\\Resources\\config\\validation.yml'), 1 => ($this->targetDirs[3].'\\vendor\\carlescliment\\calendar-bundle\\src\\BladeTester\\CalendarBundle\\Resources\\config\\validation.yml')));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CHEF' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_RESPO_COMMERCIAL' => array(0 => 'ROLE_RESPONSABLE'), 'ROLE_COMMERCIAL_ADMIN' => array(0 => 'ROLE_COMMERCIAL')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SuiviVenteBundle' => 'Suivi\\SuiviBundle\\SuiviVenteBundle',
                ...
                'YourOwnCalendarBundle' => 'Your\\OwnCalendarBundle\\YourOwnCalendarBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'gvente4',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_encryption' => 'ssl',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'haythembelkahla.26@gmail.com',
            'mailer_password' => 22298622,
            'locale' => 'fr',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_RESPO_COMMERCIAL' => array(
                    0 => 'ROLE_RESPONSABLE',
                ),
                'ROLE_COMMERCIAL_ADMIN' => array(
                    0 => 'ROLE_COMMERCIAL',
                ),
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'haythembelkahla.26@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 22298622,
            ...
            'fos_user.registration.form.type' => 'formation_user_registration',
            ...
            'blade_tester_calendar.classes.event.entity' => 'Your\\OwnCalendarBundle\\Entity\\Event',
